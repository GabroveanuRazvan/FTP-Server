...
/// Separates the ip octets with dashes; used for directory and file names.
///
...
mod tests{
    ...
    #[test]
    fn test_format_ipv4_1(){

        let ipv4 = Ipv4Addr::new(127, 0, 0, 1);
        let formatted_ip = format_ipv4(ipv4);

        assert_eq!(formatted_ip, "127-0-0-1");

    }

    #[test]
    fn test_format_ipv4_2(){

        let ipv4 = Ipv4Addr::new(0, 0, 0, 0);
        let formatted_ip = format_ipv4(ipv4);

        assert_eq!(formatted_ip, "0-0-0-0");
